    ...
    <div className="pb-24 md:pb-0">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        ...
        <div className="space-y-6">
          {/* 1. Media */}
          <section>
            <h2 className="mb-2 text-sm font-semibold">1 · Media</h2>
            {assets.length === 0 ? (
              <p className="rounded-2xl border border-dashed border-border p-4 text-sm text-muted">
                ...
                first, or post text-only where the platform allows it.
              </p>
            ) : (
          ...
          <section>
            <div className="mb-2 flex items-baseline justify-between">
              <h2 className="text-sm font-semibold">2 · Caption</h2>
            ...
            <textarea
              ...
              rows={5}
              placeholder="Write once — Branch adapts it per platform. Hashtags welcome."
          ...
          {selected.length > 0 && (
            <section>
              <h2 className="mb-2 text-sm font-semibold">4 · Per-platform tweaks</h2>
              <div className="flex gap-1 overflow-x-auto pb-2">
                {selected.map((id) => {
                  ...
                  return (
                    ...
                    >
                      {a.handle}
                      {hasError && <IconWarning width={12} height={12} className="text-danger" />}
                      {!hasError && hasWarning && (
      ...
      <div className="flex items-center gap-2">
        ...
        {scheduleOpen && (
          <>
            ...
            >
              {busy === "schedule" ? <Spinner className="border-white/40 border-t-white" /> : "Confirm"}
            </button>
          </>
        )}
      </div>
